...
public class VendorMapper implements ResultSetMapper<Vendor> {
  ...
  public final Vendor map(final int idx, final ResultSet rs, final StatementContext ctx) throws SQLException {
    ...
    String venAdress = rs.getString("VEN_ADD");
    int venWallet =  rs.getInt("VEN_WLT");

    Vendor vnd = new Vendor(venId, venName, venUsername, venPassword, venEmail, venMobileno, venAdress, venWallet);
    return vnd;
  }
}
